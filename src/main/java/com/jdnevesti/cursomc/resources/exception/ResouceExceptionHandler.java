...
import com.jdnevesti.cursomc.services.exceptions.AuthorizationException;
import com.jdnevesti.cursomc.services.exceptions.DataIntegrityException;
import com.jdnevesti.cursomc.services.exceptions.FileException;
...
public class ResouceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotFound(ObjectNotFoundException e, HttpServletRequest request){
		...
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.NOT_FOUND.value(), "Não encontrato", e.getMessage(), request.getRequestURI());
