package com.jdnevesti.cursomc.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				// .apis(RequestHandlerSelectors.any()) - para todo o projeto
				.apis(RequestHandlerSelectors.basePackage("com.jdnevesti.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
				...
				"Versão 1.0",
				"https://github.com/Developer-Neves",
				new Contact("Jonas Neves", "https://github.com/Developer-Neves", "jonasneves@outlook.com"),
				"Permitido uso para estudantes", 
				"https://github.com/Developer-Neves", 
				Collections.emptyList() // Extensões da API - nesse caso a coleção está vazia																									// Extensions
		);
	}
